...
const InstructionModal = ({ onModalClose, stepDescriptions }: InstructionModalProps) =>
{
    ...
    return (
        <Dialog open={isModalOpen} onOpenChange={handleClose}>
            <DialogContent className="w-full h-full bg-black flex flex-col justify-center items-center ">
                <DialogHeader>
                    <DialogDescription className="text-white flex flex-col h-full gap-6">
